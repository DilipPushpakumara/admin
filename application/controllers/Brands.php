	...
	*/
	public function update($id)
	{
		...
		if($id) {
			...
			$this->form_validation->set_rules('edit_contactPerson', 'Contact Person', 'trim|required');
			$this->form_validation->set_rules('edit_email', 'Email', 'trim|required');
			$this->form_validation->set_rules('edit_phoneNumber', 'Phone Number', 'trim|required');
	        ...
	        if ($this->form_validation->run() == TRUE) {
	        	$data = array(
					...
					'number' => $this->input->post('edit_phoneNumber'),
