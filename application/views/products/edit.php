          ...
          <form role="form" action="<?php base_url('users/update') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="date" class="form-control" id="ExpireDate" name="ExpireDate" placeholder="Enter ExpireDate" value="<?php echo $product_data['ExpireDate']; ?>" autocomplete="off" />
                </div>
